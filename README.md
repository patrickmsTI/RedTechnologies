# RedTechnologies
API to Create, read, update and delete Orders
...
# Define the RedThecnologies.API project as the startup project
# Change the username and password in appsettings.json ConnectionStrings to the corresponding username and password in your MySql Server
